...
import com.example.musicplayer.utils.AlbumUtils;

public class PlaybackService extends Service implements IPlayback, IPlayback.Callback {

    private static final String ACTION_PLAY_TOGGLE = "com.example.musicplayer.ACTION.PLAY_TOGGLE";
    private static final String ACTION_PLAY_LAST = "com.example.musicplayer.ACTION.PLAY_LAST";
    private static final String ACTION_PLAY_NEXT = "com.example.musicplayer.ACTION.PLAY_NEXT";
    private static final String ACTION_STOP_SERVICE = "com.example.musicplayer.ACTION.STOP_SERVICE";
